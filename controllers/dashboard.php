...
class dashboard extends controller{
	...
	public function confirm_withdraw($withdraw_id){
		$response = $this->model->confirm_withdraw($withdraw_id);
		echo Utility::convertToJSON($response);
	}
	public function confirm_payment($depositor_id){
		$response = $this->model->confirm_payment($depositor_id);
		echo Utility::convertToJSON($response);
	}
	...
	public function getPrefInfo(){
		$prefInfo = $this->model->prefInfo();
		echo Utility::convertToJSON($prefInfo); 
	}
	...
	public function withdrawBonusProfit(){
		$object = json_decode(file_get_contents('php://input'));
        $data['address'] = $this->escape_value($object->walletAddress);
        $data['type'] = $this->escape_value($object->bonusWithdrawMethod);
        $data['amount'] = $this->escape_value($object->bonusAmount);
        
        $response = $this->model->withdrawBonusProfit($data);
		echo Utility::convertToJSON($response);
	}
	...
	public function changePassword(){
        ...
        $data['confirmpassword'] = $this->escape_value($obj->confirmPassword);
...
// 		echo $response;
    ...
    public function payCharge($userId, $withdrawId){
	   	$data['userId'] = $userId;
